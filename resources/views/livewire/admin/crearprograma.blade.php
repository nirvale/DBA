...
{{-- <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalCrearPrograma">
  CREAR PROGRAMA
  <i class="fas fa-plus"></i>
</button> --}}

<!-- Modal -->
<div wire:ignore.self class="modal fade" id="modalCrearPrograma" tabindex="-1" role="dialog" aria-labelledby="modalCrearProgramaTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalCrearProgramaLongTitle">CREAR PROGRAMA</h5>
...
{{-- Inicia forma --}}
        <form class="form-crearPrograma" id="form-crearPrograma" action="javascript:void(0);" method="PUT" enctype="multipart/form-data">
          @csrf
      ...
      <div class="modal-footer">
        ...
        <button wire:click.prevent="guardarPrograma()" type="button" class="btn btn-success ">Crear Programa</button>
      </div>
    </form>
{{-- Termina forma --}}
    </div>
