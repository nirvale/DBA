                 ...
                 {"data": "archivos",
                    render: function ( data, type, row, meta ) {
                          ...
                          for (var i = 0; i < urls.length; i++) {
                            ...
                            urls2 =  urls2 + '<a style="color:green;" href="{{route('getlogs.get.s','')}}'+'/'+urls[i]+'">logfile '+ (i+1) +'</a> <br>';
                        }
                      return urls2;
                    }
                 },
            ...
            for (var j = 0; j < response[1].length; j++) {
              ...
              urls = JSON.parse(response[0][0].archivos);
                    ...
                    for (var i = 0; i < urls.length; i++) {
                      ...
                      $("#modalc2").append("<div class='col-md-12 ml-auto' ><a style='color:green;' href='{{route('getlogs.get.s','')}}"+"/"+urls[i]+"'>"+urls[i]+"</a><br></div>");
