...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      //permisos
      Permission::create([ 'guard_name' => 'web' , 'name' => 'adming'])->syncRoles($r_god,$r_admin);
      Permission::create([ 'guard_name' => 'web' , 'name' => 'admin'])->syncRoles($r_admin);
      ...
      Permission::create([ 'guard_name' => 'web' , 'name' => 'editar_bitacora'])->syncRoles($r_god,$r_admin,$r_dbas,$r_dbaj,$r_ob);
      Permission::create([ 'guard_name' => 'web' , 'name' => 'esquema'])->syncRoles($r_god,$r_admin,$r_dbas,$r_dbaj);
